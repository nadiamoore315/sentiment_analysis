...
def main():
    ...
    webpage = input("Please enter the webpage URL: ")

    # Step 4: Collect Reviews ("Scraper")
    collect_reviews(webpage)
    ...
    # get average of sentiment reviews:

    total = 0 #holds total value of sentimental reviews
    count = 0 #counts num of reviews
    for sent_num in df['sentiment']:
        count +=1
        total += sent_num
    avg_sent = total/count #holds avg of sentimental reviews
    print(f"Average of Sentimental Analysis on {count} reviews was {avg_sent}")
